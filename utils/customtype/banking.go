...
func GetBankID(code string) string {
	for id, bank := range MapBank {
		if bank["code"] == code {
			return id
		}
	}
...
func GetBankName(id string) string {
	if MapBank[id]["name"] != nil {
		return MapBank[id]["name"].(string)
	} else {
		return "Bank name not found"
	}
}
func GetBankCodeFromID(id string) string {
	res := MapBank[id]["code"]
	if res != nil {
		return res.(string)
	}
...
func GetBinCodeFromID(id string) string {
	res := MapBank[id]["bin"]
	if res != nil {
		return res.(string)
	}
...
var MapBank = map[string]map[string]any{
	"201": {
		"id":                17,
	...
	"656": {
		"id":                656,
		"name":              "Ngan hang Keb Hana - Chi Nhanh TP Ho Chi Minh",
		"code":              "KEBHANAHCM",
		"bin":               "970466",
		...
		"transferSupported": 1,
		"lookupSupported":   1,
		"short_name":        "Keb Hana - Ho Chi Minh",
		"support":           3,
		"isTransfer":        1,
		"swift_code":        "VTCBVNVX",
	},
	"626": {
		"id":                626,
		"name":              "Ngan hang Keb Hana - Chi Nhanh Ha Noi",
		"code":              "KEBHANAHN",
		"bin":               "970467",
